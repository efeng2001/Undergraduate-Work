...
void test_mlist(int argc, char** argv){
    ...
    if(all || atoi(argv[2]) == 7){
        list.clear();
        list.push_top(&m);
        Node *tmp = list.search(list.top(),"m");
        list.removeNode(tmp);
        //should not print anything T-> <-B and B-> <-T
        cout<<"T-> ";list.printTtB(" ");cout<<"<-B"<<endl;cout<<"B-> ";list.printBtT(" ");cout<<"<-T"<<endl;
        cout<<((list.top()==list.bottom())?true:false)<<endl;//true both should be NULL
        cout<<((list.top()==NULL)?true:false)<<endl;
        list.insertAfter(tmp,NULL);
        //node is back to the top and bottom position
        //T-> m <-B, B-> m <-T
        cout<<"T-> ";list.printTtB(" ");cout<<"<-B"<<endl;cout<<"B-> ";list.printBtT(" ");cout<<"<-T"<<endl;
        cout<<list.isEmpty()<<endl;//false
        cout<<((list.top()==list.bottom())?true:false)<<endl;
        cout<<((list.bottom()==tmp)?true:false)<<endl;//bottom should == top == a
        list.clear();
        list.push_top(&m);
        tmp = list.search(list.top(),"m");
        list.deleteNode(tmp);
        cout<<list.isEmpty()<<endl;//true
        //T-> <-B, B-> <-T
        cout<<"T-> ";list.printTtB(" ");cout<<"<-B"<<endl;cout<<"B-> ";list.printBtT(" ");cout<<"<-T"<<endl;
        cout<<(!list.isEmpty())<<endl;//false
        cout<<((list.top()==list.bottom())?true:false)<<endl;//true
        cout<<((list.bottom()==NULL)?true:false)<<endl;//true
    }
